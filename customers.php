...
// Fetch customers with status names and cart item counts
$sql = "
    SELECT 
        c.customer_id, 
        ...
        s.status_name, 
        c.created_at,
        COUNT(cart.cart_id) AS cart_item_count  -- Count cart items
    FROM customers c
    INNER JOIN status s ON c.status_id = s.status_id
    LEFT JOIN carts cart ON c.customer_id = cart.customer_id AND cart.cart_status = 'active'
    ...
    <div class="w-64 bg-white shadow-md">
        ...
        <nav class="mt-6">
            <ul>
                ...
                <li class="px-4 py-2 hover:bg-gray-200"><i class="fas fa-cash-register mr-2"></i><a href="inventory.php">Point of Sale</a></li>
            ...
            <table class="min-w-full table-auto border border-gray-200 shadow-md text-sm bg-white">
                <thead class="bg-gray-100 text-left text-gray-600">
                    <tr>
                        ...
                        <th class="px-4 py-3 border">Cart Items</th> <th class="px-4 py-3 border">Actions</th>
                    </tr>
                </thead>
                <tbody class="text-gray-700">
                    <?php if (!empty($customers)) { 
                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-4 py-2 border"><?php echo $customer['cart_item_count']; ?></td> <td class="px-4 py-2 border">
